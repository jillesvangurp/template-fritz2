...
class TranslationStore(
    ...
    companion object {
        ...
        suspend fun load(localeStore: Store<String>, fallback: String): TranslationStore {

            val preferred = localeStore.current
            val languages =
            ...
            val initWith = listOfNotNull(preferred, best)
            console.log(preferred,initWith.joinToString(", "))
            return TranslationStore(localeStore,provider.loadBundleSequence(initWith, fallback, Companion::fetchFtl))
        }
    }
}
